...
window.I18N.id = {
    ...
    "settings.dev_restart": "Mulai ulang aigate",
    "settings.dev_restart_confirm": "Mulai ulang server aigate? Halaman akan dimuat ulang secara otomatis saat server hidup kembali.",
    "settings.restarting": "Memulai ulang…",
    "btn.theme": "Tema",
    "btn.lang": "Bahasa",
    ...
    "provider.token_saver": "Penghemat Token",
    "provider.ts_rtk": "RTK",
    "provider.ts_caveman": "Caveman",
    "provider.ts_ponytail": "Ponytail",
    "provider.ts_help": "Nyalakan Penghemat Token untuk memangkas token, lalu pilih trik mana yang jalan. Masing-masing berdiri sendiri.",
    ...
    "providers.strategy_fill_first": "Utamakan teratas — pakai akun prioritas tertinggi sampai gagal",
    ...
    "providers.accounts_menu": "Kelola akun",
    ...
    "combos.member.order_hint": "Urutan baris = antrean percobaan. Untuk strategi beban dan biaya/latensi, yang menentukan utama bobot; urutan hanya pemecah seri.",
    ...
    "combos.member.move_up": "Naik",
    "combos.member.move_down": "Turun",
    "combos.member.drag": "Seret untuk mengurut",
    "combos.member.already_first": "Sudah paling awal",
    "combos.member.already_last": "Sudah paling akhir",
    ...
    "provider_detail.back": "Kembali ke Penyedia",
    "provider_detail.title": "Rinci penyedia",
    "provider_detail.profile": "Profil",
    "provider_detail.profile_note": "Hanya baca — pakai Ubah di atas untuk mengubahnya.",
    "provider_detail.none": "tidak ada",
    "provider_detail.strategy_card": "Pergiliran akun",
    "provider_detail.strategy_help": "Cara gateway memilih salah satu akun penyedia ini untuk tiap permintaan.",
    "provider_detail.strategy": "Strategi",
    "provider_detail.sticky_limit": "Pemakaian per akun sebelum bergilir",
    "provider_detail.save_strategy": "Simpan strategi",
    "provider_detail.strategy_saved": "Strategi tersimpan.",
    "provider_detail.save_blocked": "Buka penyedia dulu untuk menyimpan strateginya.",
    "provider_detail.add_account": "Tambah akun",
    "provider_detail.edit_account": "Ubah",
    "provider_detail.edit_title": "Ubah akun",
    "provider_detail.save_changes": "Simpan perubahan",
    "provider_detail.enabled": "Aktif",
    "provider_detail.oauth_key_note": "Akun OAuth memperbarui tokennya sendiri; tidak ada API key yang perlu diisi di sini.",
    "provider_detail.edit_error": "Gagal menyimpan perubahan",
    "provider_detail.edit_missing": "Akun ini sudah tidak ada. Daftar dimuat ulang.",
    "provider_detail.account_modal_title": "Akun baru untuk penyedia ini",
    "provider_detail.priority": "Prioritas",
    "provider_detail.priority_note": "Angka lebih kecil dicoba duluan. Urutkan nanti dengan tombol panah.",
    "provider_detail.reload": "Muat ulang",
    "provider_detail.no_accounts": "Belum ada akun. Penyedia memakai kunci API-nya sendiri sampai ada akun.",
    "provider_detail.position": "Posisi",
    "provider_detail.last_used": "Terakhir dipakai",
    "provider_detail.never_used": "belum pernah",
    "provider_detail.move_up": "Naik",
    "provider_detail.move_down": "Turun",
    "provider_detail.already_first": "Sudah paling awal",
    "provider_detail.already_last": "Sudah paling akhir",
    ...
    "nav.chat": "Obrolan",
    "page_desc.chat": "Mengobrol dengan provider atau combo yang sudah dikonfigurasi lewat gateway aigate — respons dialirkan token demi token dan setiap percakapan disimpan secara lokal.",
    "chat.sessions": "Sesi",
    "chat.new": "Obrolan baru",
    "chat.new_title": "Obrolan baru",
    "chat.title_label": "Judul",
    "chat.title": "Judul",
    "chat.model": "Model",
    "chat.create": "Buat",
    "chat.cancel": "Batal",
    ...
    "chat.rename_title": "Ganti nama percakapan",
    "chat.delete": "Hapus",
    "chat.delete_confirm": "Hapus percakapan ini? Tindakan ini tidak bisa dibatalkan.",
    "chat.system_prompt": "System prompt",
    "chat.temperature": "Suhu",
    "chat.input": "Pesan",
    "chat.input_ph": "Ketik pesan…",
    "chat.send": "Kirim",
    "chat.stop": "Hentikan",
    "chat.empty": "Pilih percakapan atau mulai yang baru.",
    "chat.no_sessions": "Belum ada percakapan.",
    "chat.thinking": "Asisten sedang berpikir…",
    "chat.role_you": "Anda",
    "chat.role_assistant": "Asisten",
    "chat.role_system": "Sistem",
    "chat.tokens": "Token",
    "chat.target_provider": "Provider",
    "chat.target_combo": "Combo",
    "chat.no_target": "Percakapan ini belum punya model.",
    "chat.error": "Terjadi kesalahan. Silakan coba lagi.",
    "chat.load_error": "Gagal memuat percakapan.",
    "chat.delete_error": "Gagal menghapus percakapan.",
    "chat.rename_error": "Gagal mengganti nama percakapan.",
    "chat.save_error": "Gagal menyimpan pengaturan.",
    "chat.send_error": "Asisten tidak bisa merespons. Coba lagi.",
    "chat.model_required": "Pilih model atau combo terlebih dahulu.",
    "chat.picker_loading": "Memuat model…",
    "chat.picker_none": "Tidak ada model yang tersedia.",
    "chat.settings": "Pengaturan",
    "chat.settings_title": "Pengaturan obrolan",
    "chat.model_switch": "Ganti model",
    "chat.model_switched": "Model diperbarui.",
    "chat.model_switch_error": "Gagal mengganti model.",
    "chat.collapse": "Ciutkan daftar sesi",
    "chat.expand": "Bentangkan daftar sesi",
    "chat.loader_01": "Berfikir…",
    "chat.loader_02": "Meramu jawaban…",
    "chat.loader_03": "Menyusun jawaban…",
    "chat.loader_04": "Menggali konteks…",
    "chat.loader_05": "Menyiapkan respons…",
    "chat.loader_06": "Memproses permintaan…",
    "chat.loader_07": "Meninjau pertanyaanmu…",
    "chat.loader_08": "Mencari informasi…",
    "chat.loader_09": "Menghubungkan gagasan…",
    "chat.loader_10": "Menganalisis masukan…",
    "chat.loader_11": "Menyusun pikiran…",
    "chat.loader_12": "Menimbang pilihan…",
    "chat.loader_13": "Merangkai kata…",
    "chat.loader_14": "Menelaah detail…",
    "chat.loader_15": "Membentuk jawaban…",
    "chat.loader_16": "Menyiapkan balasan…",
    "chat.loader_17": "Mengumpulkan fakta…",
    "chat.loader_18": "Menyaring informasi…",
    "chat.loader_19": "Melacak konteks…",
    "chat.loader_20": "Menggali makna…",
    "chat.loader_21": "Meracik jawaban…",
    "chat.loader_22": "Menata argumen…",
    "chat.loader_23": "Memecahkan soal…",
    "chat.loader_24": "Mempersiapkan respons…",
    "chat.loader_25": "Membaca pola…",
    "chat.loader_26": "Menyusun narasi…",
    "chat.loader_27": "Mengolah pertanyaan…",
    "chat.loader_28": "Menyelaraskan pikiran…",
    "chat.loader_29": "Merangkum poin…",
    "chat.loader_30": "Menyajikan jawaban…",
    "chat.loader_31": "Mengaitkan data…",
    "chat.loader_32": "Menempa kalimat…"
};
