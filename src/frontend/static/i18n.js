...
window.I18N = {
  en: {
    ...
    "combos.member.model_ph": "— select model —",
    "combos.member.model_custom": "Other (type manually)…",
    "combos.member.model_custom_ph": "model id (free text ok)",
    "combos.member.model_required": "Pick a model, or choose \"Other\" and type one.",
  ...
  id: {
    ...
    "combos.member.model": "Model",
    "combos.member.model_ph": "— pilih model —",
    "combos.member.model_custom": "Lainnya (ketik manual)…",
    "combos.member.model_custom_ph": "id model (teks bebas boleh)",
    "combos.member.model_required": "Pilih model, atau pilih \"Lainnya\" lalu ketik sendiri.",
